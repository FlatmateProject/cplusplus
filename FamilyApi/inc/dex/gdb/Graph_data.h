...
#ifndef _DEX_GRAPH_DATA_H_
#define _DEX_GRAPH_DATA_H_
...
public:
    ...
    /**
     * \brief Gets the Dex type identifier.
     * \return The Dex type identifier.
     */
    type_t GetId() const
    {
        return ident;
...
/**
 * \brief Dex type identifier list.
 *
 * It stores a Dex node or edge type identifier list.
 *
 * Use TypeListIterator to access all elements into this collection.
 *
 * \author Sparsity Technologies http://www.sparsity-technologies.com
 */
class DEX_EXPORT TypeList
{
public:
    ...
    /**
     * \brief Adds a Dex type identifier at the end of the list.
...
/**
 * \brief TypeListIterator class.
 *
 * Iterator to traverse all the Dex node or edge type identifiers into a 
 * TypeList instance.
 *
 * \author Sparsity Technologies http://www.sparsity-technologies.com
 */
class DEX_EXPORT TypeListIterator
{
...
public:
    ...
    /**
     * \brief Gets the Dex attribute identifier.
     * \return The Dex attribute identifier.
     */
    attr_t GetId() const
    {
        return ident;
...
/**
 * \brief Dex attribute identifier list.
 *
 * It stores a Dex attribute identifier list.
 *
 * Use AttributeListIterator to access all elements into this collection.
 *
 * \author Sparsity Technologies http://www.sparsity-technologies.com
 */
class DEX_EXPORT AttributeList
{
public:
    ...
    /**
     * \brief Adds a Dex attribute identifier at the end of the list.
...
/**
 * \brief Dex object identifier list.
 *
...
public:
    ...
    /**
     * \brief Adds a Dex object identifier at the end of the list.
     * \param attr [in] Dex object identifier.
     */
    void Add(oid_t attr) 
    {
        list.push_back(attr);
...
/**
 * \brief OIDListIterator class.
 *
 * Iterator to traverse all the Dex object identifier into a OIDList instance.
 *
 * \author Sparsity Technologies http://www.sparsity-technologies.com
 */
class DEX_EXPORT OIDListIterator
{
 ...
 * \author Sparsity Technologies http://www.sparsity-technologies.com
 */
class DEX_EXPORT AttributeStatistics
{
    friend class Graph; // to set private fields
...
public:
    ...
    /**
     * \brief Gets the number of objects NULL a Value.
    ...
    /**
     * \brief Gets the number of distinct values.
    ...
    /**
     * \brief Gets the minimum existing value.
    ...
    /**
     * \brief Gets the maximum existing value.
 ...
 *
 * It stores the tail and the head of an edge.
 * 
...
private:
    ...
    /**
     * \brief Dex edge identifier.
     */
    oid_t edge;
    
    /**
     * \brief Dex edge identifier of the tail of the edge.
     */
    oid_t tail;
    
    /**
     * \brief Dex edge identifier of the head of the edge.
     */
    oid_t head;
...
public:
     ...
     * \return The Dex edge identifier.
     */
    oid_t GetEdge() const
    {
        return edge;
     ...
     * \return The Dex edge identifier of the tail of the edge.
     */
    oid_t GetTail() const
    {
        return tail;
     ...
     * \return The Dex edge identifier of the head of the edge.
     */
    oid_t GetHead() const
    {
        return head;
...
/**
 * \brief StringListIterator class.
 *
 * Iterator to traverse all the strings into a StringList instance.
 *
 * \author Sparsity Technologies http://www.sparsity-technologies.com
 */
class DEX_EXPORT StringListIterator
{
...
private:
     ...
     * \brief Boolean list.
     */
    std::vector<dex::gdb::bool_t> list;
};


/**
 * \brief BooleanListIterator class.
 *
 * Iterator to traverse all the strings into a BooleanList instance.
 *
 * \author Sparsity Technologies http://www.sparsity-technologies.com
 */
class DEX_EXPORT BooleanListIterator
{
...
private:
     ...
     * \brief std vector iterator.
     */
    std::vector<dex::gdb::bool_t>::iterator it;
    
    /**
     * \brief Ending std vector iterator.
     */
    std::vector<dex::gdb::bool_t>::iterator end;
    
    /**
     * \brief Creates a new instance.
     * \param list List to iterate.
     */
    BooleanListIterator(std::vector<dex::gdb::bool_t> & list);
...
/**
 * \brief Dex 32-bit signed integer list.
 *
...
/**
 * \brief Int32ListIterator class.
 *
 * Iterator to traverse all the integer into a Int32List instance.
 *
 * \author Sparsity Technologies http://www.sparsity-technologies.com
 */
class DEX_EXPORT Int32ListIterator
{
