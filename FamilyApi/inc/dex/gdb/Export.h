...
#ifndef _DEX_EXPORT_H_
#define _DEX_EXPORT_H_
 ...
 * Nowadays, these are the available formats: (i) ExportType.Graphviz,
 * (ii) ExportType.GraphML, and (iii) ExportType.YGraphML
 *
 * \author Sparsity Technologies http://www.sparsity-technologies.com
 */
class DEX_EXPORT ExportManager 
{
public:
 ...
 * \author Sparsity Technologies http://www.sparsity-technologies.com
 */
class DEX_EXPORT DefaultExport 
...
public:
    ...
    /**
     * \brief ExportManager#Prepare
     */
    void Prepare(Graph * graph);
    
    /**
     * \brief ExportManager#Release
     */
    void Release();
    
    /**
     * \brief ExportManager#GetGraph
     * 
    ...
    /**
     * \brief ExportManager#GetNodeType
     *
    ...
    /**
     * \brief ExportManager#GetEdgeType
     *
    ...
    /**
     * \brief ExportManager#EnableType
     *
