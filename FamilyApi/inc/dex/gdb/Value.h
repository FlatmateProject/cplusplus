...
#ifndef _DEX_VALUE_H_
#define _DEX_VALUE_H_
 ...
 * \brief Value class.
 *
 * It is a container which stores a value and its data type.
 * A Value can be NULL.
 *
 * \author Sparsity Technologies http://www.sparsity-technologies.com
 */
class DEX_EXPORT Value
: private Handler<dexcore::Value>
{
    friend class Graph; // to access private handler
    friend class ValuesIterator; // to access private SetVoid(dexcore::Value)
...
private:
    ...
    /**
     * \brief Sets the Value from a dexcore Value.
     * \param v [in] Dexcore Value.
     */
    void SetVoid(dexcore::Value & core_v);
    
    /**
     * \brief Creates a new instance from a dexcore Value.
     * \param core_v [in] Dexcore Value to be copied.
     */
    Value(const dexcore::Value & core_v);
};
